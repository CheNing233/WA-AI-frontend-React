...
const repository = [
    {
        title: 'Github-前端',
        image: require('@/assets/logo/github.png'),
...
const developers = [
    {
        title: 'xChenNing',
        image: 'https://avatars.githubusercontent.com/u/32773451?v=4',
        desc: '前端、PM 、菜鸡',
        git: 'https://github.com/CheNing233',
    },
    {
        title: 'liahnu',
        image: 'https://avatars.githubusercontent.com/u/49276659?v=4',
        desc: '后端、运维、大佬',
        git: 'https://github.com/1328411791',
    },
    {
        title: 'Polister',
        image: 'https://avatars.githubusercontent.com/u/151947504?v=4',
        desc: '后端、全栈大佬',
        git: 'https://github.com/ZPolister',
    },
    {
        title: 'ECAMT35',
        image: 'https://avatars.githubusercontent.com/u/161866427?v=4',
        desc: '后端、大佬',
